...
// XAudio 2.8
interface COMPILER_UUID(60d8dac8-5aa1-4e8e-b597-2f5e2883d484) IXAudio2;
...
typedef struct XAUDIO2_PERFORMANCE_DATA
{
    ...
    UINT32 GlitchesSinceEngineStarted;  // Audio dropouts since the render was started.
...
DECLARE_INTERFACE_(IXAudio2, IUnknown)
{
    ...
    // DESCRIPTION: Adds a new client to receive XAudio2's render callbacks.
    //
    // ARGUMENTS:
    ...
    // DESCRIPTION: Removes an existing receiver of XAudio2 render callbacks.
    //
    // ARGUMENTS:
...
/**************************************************************************
 *
 * IXAudio2EngineCallback: Client notification interface for render events.
 *
 * REMARKS: Contains methods to notify the client when certain events happen
 *          in the XAudio2 render.  This interface should be implemented by
