...
typedef
  ...
  int32_t
#endif
TPE_Unit;               ///< Basic fixed point unit type.
...
typedef
  ...
  int16_t
#endif
TPE_UnitReduced;    ///< Like TPE_Unit but saving space
...
inline constexpr std::size_t TPE_INFINITY = std::numeric_limits<TPE_Unit>::max();
