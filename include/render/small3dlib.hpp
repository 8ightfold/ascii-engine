...
inline uint16_t S3L_resolutionX = 512; /**< If a static resolution is not set with
...
inline uint16_t S3L_resolutionY = 512; /**< Same as S3L_resolutionX, but for Y
                                       resolution. */
...
inline S3L_Unit S3L_zBuffer[S3L_MAX_PIXELS];
...
inline S3L_Unit S3L_zBufferRead(S3L_ScreenCoord x, S3L_ScreenCoord y)
{
#if S3L_Z_BUFFER
...
inline void S3L_zBufferWrite(S3L_ScreenCoord x, S3L_ScreenCoord y, S3L_Unit value)
{
#if S3L_Z_BUFFER
...
inline void S3L_vec4Set(S3L_Vec4 *v, S3L_Unit x, S3L_Unit y, S3L_Unit z, S3L_Unit w)
{
    v->x = x;
    v->y = y;
    v->z = z;
...
inline void S3L_mat4Init(S3L_Mat4 m)
{
#define M(x,y) m[x][y]
...
inline void S3L_mat4Copy(S3L_Mat4 src, S3L_Mat4 dst)
{
...
inline void S3L_reflect(S3L_Vec4 toLight, S3L_Vec4 normal, S3L_Vec4 *result)
{
...
inline void S3L_vec3Cross(S3L_Vec4 a, S3L_Vec4 b, S3L_Vec4 *result)
{
...
inline void S3L_triangleNormal(S3L_Vec4 t0, S3L_Vec4 t1, S3L_Vec4 t2, S3L_Vec4 *n)
{
...
inline void S3L_getIndexedTriangleValues(
        S3L_Index triangleIndex,
        const S3L_Index *indices,
        const S3L_Unit *values,
        uint8_t numComponents,
...
inline void S3L_computeModelNormals(S3L_Model3D model, S3L_Unit *dst,
                             int8_t transformNormals)
{
    S3L_Index vPos = 0;
...
inline void S3L_vec4Xmat4(S3L_Vec4 *v, S3L_Mat4 m)
{
    S3L_Vec4 vBackup;
...
inline void S3L_vec3Xmat4(S3L_Vec4 *v, S3L_Mat4 m)
{
    S3L_Vec4 vBackup;
...
inline S3L_Unit S3L_interpolate(S3L_Unit v1, S3L_Unit v2, S3L_Unit t, S3L_Unit tMax)
{
    return v1 + ((v2 - v1) * t) / tMax;
}

inline S3L_Unit S3L_interpolateByUnit(S3L_Unit v1, S3L_Unit v2, S3L_Unit t)
{
    return v1 + ((v2 - v1) * t) / S3L_FRACTIONS_PER_UNIT;
}

inline S3L_Unit S3L_interpolateByUnitFrom0(S3L_Unit v2, S3L_Unit t)
{
    return (v2 * t) / S3L_FRACTIONS_PER_UNIT;
}

inline S3L_Unit S3L_interpolateFrom0(S3L_Unit v2, S3L_Unit t, S3L_Unit tMax)
{
    return (v2 * t) / tMax;
}
...
inline void S3L_mat4Xmat4(S3L_Mat4 m1, S3L_Mat4 m2)
{
    S3L_Mat4 mat1;
...
inline S3L_Unit S3L_sin(S3L_Unit x)
{
#if S3L_SIN_METHOD == 0
...
inline S3L_Unit S3L_asin(S3L_Unit x)
{
#if S3L_SIN_METHOD == 0
...
inline void S3L_correctBarycentricCoords(S3L_Unit barycentric[3])
{
...
inline void S3L_makeTranslationMat(
        S3L_Unit offsetX,
        S3L_Unit offsetY,
        S3L_Unit offsetZ,
        S3L_Mat4 m)
...
inline void S3L_makeScaleMatrix(
        S3L_Unit scaleX,
        S3L_Unit scaleY,
        S3L_Unit scaleZ,
        S3L_Mat4 m)
...
inline void S3L_makeRotationMatrixZXY(
        S3L_Unit byX,
        S3L_Unit byY,
        S3L_Unit byZ,
        S3L_Mat4 m)
...
inline S3L_Unit S3L_sqrt(S3L_Unit value)
{
    int8_t sign = 1;
...
inline S3L_Unit S3L_vec3Length(S3L_Vec4 v)
{
    return S3L_sqrt(v.x * v.x + v.y * v.y + v.z * v.z);
}

inline S3L_Unit S3L_vec2Length(S3L_Vec4 v)
{
    return S3L_sqrt(v.x * v.x + v.y * v.y);
}

inline void S3L_vec3Normalize(S3L_Vec4 *v)
{
#define SCALE 16
...
inline void S3L_transform3DInit(S3L_Transform3D *t)
{
...
inline void S3L_project3DPointToScreen(
        S3L_Vec4 point,
        S3L_Camera camera,
        S3L_Vec4 *result)
{
...
inline void S3L_lookAt(S3L_Vec4 pointTo, S3L_Transform3D *t)
{
    S3L_Vec4 v;
...
inline void S3L_transform3DSet(
        S3L_Unit tx,
        S3L_Unit ty,
        S3L_Unit tz,
        S3L_Unit rx,
...
inline void S3L_cameraInit(S3L_Camera *camera)
{
    camera->focalLength = S3L_FRACTIONS_PER_UNIT;
    S3L_transform3DInit(&(camera->transform));
}

inline void S3L_rotationToDirections(
        S3L_Vec4 rotation,
        S3L_Unit length,
        S3L_Vec4 *forw,
        S3L_Vec4 *right,
...
inline void S3L_pixelInfoInit(S3L_PixelInfo *p)
{
    p->x = 0;
    p->y = 0;
...
inline void S3L_drawConfigInit(S3L_DrawConfig *config)
{
...
inline void S3L_stencilBufferClear()
{
#if S3L_STENCIL_BUFFER
...
*/
inline uint8_t _S3L_projectedTriangleState = 0; // 0 = normal, 1 = cut, 2 = split

#if S3L_NEAR_CROSS_STRATEGY == 3
inline S3L_Vec4 _S3L_triangleRemapBarycentrics[6];
#endif

inline void S3L_drawTriangle(
        S3L_Vec4 point0,
        S3L_Vec4 point1,
        S3L_Vec4 point2,
        S3L_Index modelIndex,
...
inline void S3L_makeWorldMatrix(S3L_Transform3D worldTransform, S3L_Mat4 m)
{
    S3L_makeScaleMatrix(
...
inline void S3L_mat4Transpose(S3L_Mat4 m)
{
    S3L_Unit tmp;
...
inline void S3L_makeCameraMatrix(S3L_Transform3D cameraTransform, S3L_Mat4 m)
{
    S3L_makeTranslationMat(
...
inline void _S3L_projectVertex(
...
inline void _S3L_mapProjectedVertexToScreen(S3L_Vec4 *vertex, S3L_Unit focalLength)
{
...
*/
inline void _S3L_projectTriangle(
        const S3L_Model3D *model,
        S3L_Index triangleIndex,
        S3L_Mat4 matrix,
...
inline void S3L_drawScene(S3L_Scene scene)
{
